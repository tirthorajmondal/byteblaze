        ...
        <div className="flex flex-col justify-center max-w-xs mx-auto p-6 shadow-md rounded-xl sm:px-12">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-300">
                ...
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <a href={`https://github.com/${github_username}`} target='_blank' aria-label="GitHub" className="p-2 rounded-md hover:text-default-600">
                    ...
                    <a href={website_url} target='_blank' aria-label="Dribble" className="p-2 rounded-md  hover:text-default-600">
                    ...
                    <a href={`https://x.com/${twitter_username}`} target='_blank' aria-label="Twitter" className="p-2 rounded-md hover:text-default-600">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
